...
public interface ITrainTransferHelper {
     ...
     *
     * @param requester the source MinecartEntity
     ...
     * @see mods.railcraft.api.carts.IFluidCart
     */
    default ItemStack pushStack(MinecartEntity requester, ItemStack stack) {
        return stack;
    }
     ...
     * @see mods.railcraft.api.carts.IItemCart
     */
    default ItemStack pullStack(MinecartEntity requester, Predicate<ItemStack> filter) {
     ...
     */
    default void offerOrDropItem(MinecartEntity requester, ItemStack stack) {
    }
     ...
     */
    default Optional<IItemHandlerModifiable> getTrainItemHandler(MinecartEntity cart) {
     ...
     * @see mods.railcraft.api.carts.IFluidCart
     */
    default @Nullable FluidStack pushFluid(MinecartEntity requester, FluidStack fluidStack) {
        return fluidStack;
    }
     ...
     * @see mods.railcraft.api.carts.IFluidCart
     */
    default @Nullable FluidStack pullFluid(MinecartEntity requester, @Nullable FluidStack fluidStack) {
        return null;
    }
     ...
     * @param cart a cart in the train
     */
    default Optional<IFluidHandler> getTrainFluidHandler(MinecartEntity cart) {
        return Optional.empty();
    }
}
