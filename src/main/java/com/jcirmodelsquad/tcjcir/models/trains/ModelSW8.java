...
public class ModelSW8 extends ModelConverter //Same as Filename
{
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
		...
		if (entity instanceof AbstractTrains && ((AbstractTrains) entity).getColor() == 16546455) {
			Tessellator.bindTexture(new ResourceLocation(Info.resourceLocation, "textures/trains/typeAclassico_Black_Brown.png"));//this code is here for other truck colors once i get around to it
			GL11.glPushMatrix();
			...
			Tessellator.bindTexture(new ResourceLocation(Info.resourceLocation, "textures/trains/typeAclassico_Black.png"));//this code is here for other truck colors once i get around to it
			GL11.glPushMatrix();
