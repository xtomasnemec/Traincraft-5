...
public class ModelSD40T2 extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[66] = new ModelRendererTurbo(this, 297, 49, textureX, textureY, "lamp"); // Box 118 liveryimg 2 glow
		bodyModel[67] = new ModelRendererTurbo(this, 249, 25, textureX, textureY, "lamp"); // Box 186 headlight front
		bodyModel[68] = new ModelRendererTurbo(this, 265, 25, textureX, textureY, "lamp"); // Box 187 headlight front
		...
		bodyModel[149] = new ModelRendererTurbo(this, 193, 33, textureX, textureY, "lamp"); // Box 176 glow
		bodyModel[150] = new ModelRendererTurbo(this, 393, 33, textureX, textureY, "lamp"); // Box 176 glow
		...
		bodyModel[177] = new ModelRendererTurbo(this, 177, 57, textureX, textureY, "lamp"); // Box 162 commander beacon
		...
		bodyModel[184] = new ModelRendererTurbo(this, 401, 81, textureX, textureY, "lamp"); // Box 189 ditchlight front
		bodyModel[185] = new ModelRendererTurbo(this, 481, 81, textureX, textureY, "lamp"); // Box 190 ditchlight front
		bodyModel[186] = new ModelRendererTurbo(this, 305, 89, textureX, textureY); // Box 239
		bodyModel[187] = new ModelRendererTurbo(this, 425, 89, textureX, textureY, "lamp"); // Box 240 ditchlight rear
		bodyModel[188] = new ModelRendererTurbo(this, 433, 89, textureX, textureY, "lamp"); // Box 241ditchlight rear
		...
		bodyModel[191] = new ModelRendererTurbo(this, 409, 73, textureX, textureY, "lamp"); // Box 410 commander beacon
		...
		bodyModel[197] = new ModelRendererTurbo(this, 97, 97, textureX, textureY, "lamp"); // Box 416 ditchlight front
		bodyModel[198] = new ModelRendererTurbo(this, 305, 97, textureX, textureY); // Box 417
		bodyModel[199] = new ModelRendererTurbo(this, 329, 97, textureX, textureY, "lamp"); // Box 418 ditchlight front
		...
		bodyModel[206] = new ModelRendererTurbo(this, 441, 97, textureX, textureY, "lamp"); // Box 337 lamp
		bodyModel[207] = new ModelRendererTurbo(this, 449, 97, textureX, textureY, "lamp"); // Box 338 lamp
		...
		bodyModel[227] = new ModelRendererTurbo(this, 49, 105, textureX, textureY, "lamp"); // Box 340 commander beacon
		...
		bodyModel[258] = new ModelRendererTurbo(this, 505, 105, textureX, textureY, "lamp"); // Box 247 lamp gyralight rear
		bodyModel[259] = new ModelRendererTurbo(this, 257, 113, textureX, textureY, "lamp"); // Box 248 lamp gyralight rear
		bodyModel[260] = new ModelRendererTurbo(this, 265, 113, textureX, textureY, "lamp"); // Box 386 lamp rear
		bodyModel[261] = new ModelRendererTurbo(this, 281, 113, textureX, textureY, "lamp"); // Box 387lamp rear
		bodyModel[262] = new ModelRendererTurbo(this, 289, 113, textureX, textureY, "lamp"); // Box 388 light red gyralight rear
		...
		bodyModel[279] = new ModelRendererTurbo(this, 153, 121, textureX, textureY, "lamp"); // Box 314 lamp sp
		bodyModel[280] = new ModelRendererTurbo(this, 161, 121, textureX, textureY, "lamp"); // Box 315 lamp sp
		bodyModel[281] = new ModelRendererTurbo(this, 193, 121, textureX, textureY, "lamp"); // Box 316 lamp sp gyralight
		...
		bodyModel[286] = new ModelRendererTurbo(this, 329, 121, textureX, textureY, "lamp"); // Box 299 lamp drgw rear
		bodyModel[287] = new ModelRendererTurbo(this, 489, 121, textureX, textureY, "lamp"); // Box 300 lamp drgw rear
		bodyModel[288] = new ModelRendererTurbo(this, 41, 129, textureX, textureY); // Box 409
		bodyModel[289] = new ModelRendererTurbo(this, 25, 129, textureX, textureY, "lamp"); // Box 410 commander beacon
		...
		bodyModel[318] = new ModelRendererTurbo(this, 369, 129, textureX, textureY, "lamp"); // Box 337 ditchlight rear
		...
		bodyModel[321] = new ModelRendererTurbo(this, 465, 129, textureX, textureY, "lamp"); // Box 340 ditchlight rear
		...
		bodyModel[2].setRotationPoint(-19F, -3F, -11F);

		bodyModel[3].addBox(0F, 0F, 0F, 64, 21, 14, 0F); // Box 34
		bodyModel[3].setRotationPoint(-19F, -22F, -7F);

		bodyModel[4].addBox(0F, 0F, 0F, 24, 6, 16, 0F); // Box 112
		bodyModel[4].setRotationPoint(-12.5F, 2F, -8F);
		...
		bodyModel[6].setRotationPoint(-49.01F, -1F, -9F);

		bodyModel[7].addBox(0F, 0F, 0F, 0, 5, 1, 0F); // Box 246
		bodyModel[7].setRotationPoint(-49F, 1F, -10F);

		bodyModel[8].addBox(0F, 0F, 0F, 0, 5, 1, 0F); // Box 247
		bodyModel[8].setRotationPoint(-49F, 1F, 9F);
		...
		bodyModel[9].setRotationPoint(-45F, 1F, 7F);
		...
		bodyModel[10].setRotationPoint(-45F, -1F, 7F);
		...
		bodyModel[11].setRotationPoint(-45F, 4F, -11F);
		...
		bodyModel[12].setRotationPoint(-45F, 4F, 7F);
		...
		bodyModel[14].setRotationPoint(-49.01F, -9F, -8F);
		...
		bodyModel[15].setRotationPoint(-49.01F, -9F, 8F);

		bodyModel[16].addBox(0F, 0F, 0F, 0, 7, 1, 0F); // Box 61
		bodyModel[16].setRotationPoint(-49F, -3F, 10F);

		bodyModel[17].addBox(0F, 0F, 0F, 0, 7, 1, 0F); // Box 63
		bodyModel[17].setRotationPoint(-49F, -3F, -11F);

		bodyModel[18].addBox(0F, 0F, 0F, 4, 2, 3, 0F); // Box 4
		bodyModel[18].setRotationPoint(-53F, 3F, -1.5F);

		bodyModel[19].addBox(0F, 0F, 0F, 3, 0, 4, 0F); // Box 98
		bodyModel[19].setRotationPoint(-53.01F, -1F, -2F);

		bodyModel[20].addBox(0F, 0F, 0F, 3, 3, 14, 0F); // Box 197
		bodyModel[20].setRotationPoint(-49F, -1F, -7F);
		...
		bodyModel[21].setRotationPoint(-49F, -9F, -7F);

		bodyModel[22].addBox(0F, 0F, 0F, 0, 8, 1, 0F); // Box 144
		bodyModel[22].setRotationPoint(-49F, -9F, -8F);

		bodyModel[23].addBox(0F, 0F, 0F, 0, 8, 8, 0F); // Box 145
		bodyModel[23].setRotationPoint(-50F, -9F, -4F);
		...
		bodyModel[24].setRotationPoint(-49F, -9F, 4F);

		bodyModel[25].addBox(0F, 0F, 0F, 0, 8, 1, 0F); // Box 148
		bodyModel[25].setRotationPoint(-49F, -9F, 7F);
		...
		bodyModel[26].setRotationPoint(-52F, 6F, 0F);
		...
		bodyModel[27].setRotationPoint(-52F, 3F, 2F);
		...
		bodyModel[28].setRotationPoint(-52F, 7F, 0F);
		...
		bodyModel[29].setRotationPoint(-52F, 6F, -10F);
		...
		bodyModel[30].setRotationPoint(-52.5F, 3F, -10F);
		...
		bodyModel[41].setRotationPoint(48F, 6F, 0F);
		...
		bodyModel[42].setRotationPoint(48F, 3F, 2F);
		...
		bodyModel[43].setRotationPoint(48F, 7F, 0F);
		...
		bodyModel[44].setRotationPoint(48F, 6F, -10F);
		...
		bodyModel[45].setRotationPoint(48.5F, 3F, -10F);
		...
		bodyModel[59].setRotationPoint(-31F, -22F, -11F);
		...
		bodyModel[60].setRotationPoint(-20F, -22F, -11F);

		bodyModel[61].addBox(0F, 0F, 0F, 1, 3, 14, 0F); // Box 211
		bodyModel[61].setRotationPoint(-31F, -22F, -7F);

		bodyModel[62].addBox(0F, 0F, 0F, 2, 4, 2, 0F); // Box 48 lamp
		bodyModel[62].setRotationPoint(-33F, -22F, -1F);
		...
		bodyModel[63].setRotationPoint(-33F, -22F, -6F);
		...
		bodyModel[67].setRotationPoint(-33.5F, -22F, -1F);
		...
		bodyModel[68].setRotationPoint(-33.5F, -20F, -1F);

		bodyModel[69].addBox(0F, 0F, 0F, 1, 3, 14, 0F); // Box 219
		bodyModel[69].setRotationPoint(-20F, -22F, -7F);

		bodyModel[70].addBox(0F, 0F, 0F, 10, 1, 14, 0F); // Box 220
		bodyModel[70].setRotationPoint(-30F, -22F, -7F);
		...
		bodyModel[71].setRotationPoint(-30F, -22F, -11F);
		...
		bodyModel[72].setRotationPoint(-30F, -22F, 7F);
		...
		bodyModel[73].setRotationPoint(-20F, -22F, 7F);
		...
		bodyModel[74].setRotationPoint(-31F, -22F, 7F);
		...
		bodyModel[75].setRotationPoint(48F, 7F, -10F);
		...
		bodyModel[76].setRotationPoint(-49F, 7F, -10F);

		bodyModel[77].addBox(0F, 0F, 0F, 0, 1, 22, 0F); // Box 227
		bodyModel[77].setRotationPoint(-49F, 6F, -11F);

		bodyModel[78].addBox(0F, 0F, 0F, 30, 1, 4, 0F); // Box 229
		bodyModel[78].setRotationPoint(-44F, 0F, -11F);

		bodyModel[79].addBox(0F, 0F, 0F, 30, 1, 4, 0F); // Box 230
		bodyModel[79].setRotationPoint(-44F, 0F, 7F);

		bodyModel[80].addBox(0F, 0F, 0F, 31, 1, 4, 0F); // Box 231
		bodyModel[80].setRotationPoint(13F, 0F, 7F);

		bodyModel[81].addBox(0F, 0F, 0F, 31, 1, 4, 0F); // Box 232
		bodyModel[81].setRotationPoint(13F, 0F, -11F);

		bodyModel[82].addBox(0F, 0F, 0F, 24, 4, 3, 0F); // Box 233
		bodyModel[82].setRotationPoint(-12.5F, 2F, -11F);
		...
		bodyModel[83].setRotationPoint(-12.5F, 6F, -11F);

		bodyModel[84].addBox(0F, 0F, 0F, 24, 4, 3, 0F); // Box 235
		bodyModel[84].setRotationPoint(-12.5F, 2F, 8F);
		...
		bodyModel[85].setRotationPoint(-12.5F, 6F, 8F);
		...
		bodyModel[86].setRotationPoint(-7F, 0F, 9F);
		...
		bodyModel[87].setRotationPoint(-7F, 1F, 9F);
		...
		bodyModel[88].setRotationPoint(-7F, 1F, -11F);
		...
		bodyModel[89].setRotationPoint(-7F, 0F, -11F);
		...
		bodyModel[90].setRotationPoint(-14F, 0F, -11F);
		...
		bodyModel[91].setRotationPoint(-14F, 0F, 7F);
		...
		bodyModel[92].setRotationPoint(12F, 0F, 7F);
		...
		bodyModel[93].setRotationPoint(12F, 0F, -11F);

		bodyModel[94].addBox(0F, 0F, 0F, 7, 4, 4, 0F); // Box 245
		bodyModel[94].setRotationPoint(-38F, -5F, -11F);

		bodyModel[95].addBox(0F, 0F, 0F, 7, 4, 4, 0F); // Box 246
		bodyModel[95].setRotationPoint(-38F, -5F, 7F);

		bodyModel[96].addBox(0F, 0F, 0F, 0, 13, 2, 0F); // Box 81
		bodyModel[96].setRotationPoint(-45F, -9F, -11F);
		...
		bodyModel[97].setRotationPoint(-45F, -7F, -11.5F);
		...
		bodyModel[98].setRotationPoint(-45F, -7F, 10.5F);

		bodyModel[99].addBox(0F, 0F, 0F, 0, 13, 2, 0F); // Box 177
		bodyModel[99].setRotationPoint(-45F, -9F, 9F);

		bodyModel[100].addBox(0F, 0F, 0F, 3, 0, 1, 0F); // Box 271
		bodyModel[100].setRotationPoint(-49F, 0F, -8F);

		bodyModel[101].addBox(0F, 0F, 0F, 4, 0, 2, 0F); // Box 274
		bodyModel[101].setRotationPoint(-49F, 2F, -9F);

		bodyModel[102].addBox(0F, 0F, 0F, 4, 1, 0, 0F); // Box 258
		bodyModel[102].setRotationPoint(-45F, -9F, -11F);

		bodyModel[103].addBox(0F, 0F, 0F, 1, 7, 0, 0F); // Box 259
		bodyModel[103].setRotationPoint(-43F, -8F, -11F);

		bodyModel[104].addBox(0F, 0F, 0F, 6, 1, 0, 0F); // Box 260
		bodyModel[104].setRotationPoint(-37F, -13F, -11F);
		...
		bodyModel[105].setRotationPoint(-41F, -9F, -11F);

		bodyModel[106].addBox(0F, 0F, 0F, 1, 7, 0, 0F); // Box 262
		bodyModel[106].setRotationPoint(-36F, -12F, -11F);

		bodyModel[107].addBox(0F, 0F, 0F, 1, 7, 0, 0F); // Box 263
		bodyModel[107].setRotationPoint(-36F, -12F, 11F);

		bodyModel[108].addBox(0F, 0F, 0F, 1, 7, 0, 0F); // Box 264
		bodyModel[108].setRotationPoint(-43F, -8F, 11F);

		bodyModel[109].addBox(0F, 0F, 0F, 4, 1, 0, 0F); // Box 265
		bodyModel[109].setRotationPoint(-45F, -9F, 11F);
		...
		bodyModel[110].setRotationPoint(-41F, -9F, 11F);

		bodyModel[111].addBox(0F, 0F, 0F, 6, 1, 0, 0F); // Box 267
		bodyModel[111].setRotationPoint(-37F, -13F, 11F);
		...
		bodyModel[112].setRotationPoint(-51F, -1F, -7F);
		...
		bodyModel[113].setRotationPoint(-51F, -1F, 0F);

		bodyModel[114].addBox(0F, 0F, 0F, 1, 8, 3, 0F); // Box 270
		bodyModel[114].setRotationPoint(-19F, -11F, -10F);

		bodyModel[115].addBox(0F, 0F, 0F, 8, 11, 2, 0F); // Box 271
		bodyModel[115].setRotationPoint(-16F, -14F, -9F);
		...
		bodyModel[116].setRotationPoint(-16F, -16F, -9F);
		...
		bodyModel[117].setRotationPoint(-17F, -23F, -6F);

		bodyModel[118].addBox(0F, 0F, 0F, 2, 1, 5, 0F); // Box 274
		bodyModel[118].setRotationPoint(-8F, -23.5F, -2.5F);

		bodyModel[119].addBox(0F, 0F, 0F, 4, 1, 8, 0F); // Box 275
		bodyModel[119].setRotationPoint(-9F, -22.5F, -4F);

		bodyModel[120].addBox(0F, 0F, 0F, 6, 1, 6, 0F); // Box 278
		bodyModel[120].setRotationPoint(-3F, -23F, -3F);

		bodyModel[121].addBox(0F, 0F, 0F, 6, 1, 6, 0F); // Box 280
		bodyModel[121].setRotationPoint(4F, -23F, -3F);

		bodyModel[122].addBox(0F, 0F, 0F, 1, 4, 0, 0F); // Box 281
		bodyModel[122].setRotationPoint(-39F, -5F, -11F);
		...
		bodyModel[123].setRotationPoint(-40F, -5F, -11F);
		...
		bodyModel[124].setRotationPoint(-40F, -5F, 11F);

		bodyModel[125].addBox(0F, 0F, 0F, 1, 4, 0, 0F); // Box 284
		bodyModel[125].setRotationPoint(-39F, -5F, 11F);

		bodyModel[126].addBox(0F, 0F, 0F, 9, 5, 1, 0F); // Box 285
		bodyModel[126].setRotationPoint(-18F, -21.5F, -7.5F);

		bodyModel[127].addBox(0F, 0F, 0F, 9, 5, 1, 0F); // Box 286
		bodyModel[127].setRotationPoint(-18F, -21.5F, 6.5F);

		bodyModel[128].addBox(0F, 0F, 0F, 0, 6, 2, 0F); // Box 288
		bodyModel[128].setRotationPoint(44F, 1F, -11F);

		bodyModel[129].addBox(0F, 0F, 0F, 59, 8, 0, 0F); // Box 291
		bodyModel[129].setRotationPoint(-15F, -9F, 11F);

		bodyModel[130].addBox(0F, 0F, 0F, 2, 4, 4, 0F); // Box 292
		bodyModel[130].setRotationPoint(-19F, -5F, 7F);

		bodyModel[131].addBox(0F, 0F, 0F, 1, 4, 0, 0F); // Box 293
		bodyModel[131].setRotationPoint(-17F, -5F, 11F);
		...
		bodyModel[132].setRotationPoint(-16F, -5F, 11F);

		bodyModel[133].addBox(0F, 0F, 0F, 1, 1, 0, 0F); // Box 295
		bodyModel[133].setRotationPoint(-19F, -13F, 11F);
		...
		bodyModel[134].setRotationPoint(-18F, -11F, 11F);
		...
		bodyModel[135].setRotationPoint(-50F, -1F, 5F);
		...
		bodyModel[136].setRotationPoint(-50F, -1F, -5F);
		...
		bodyModel[137].setRotationPoint(-50F, -1F, -6F);
		...
		bodyModel[138].setRotationPoint(-19F, -22F, -11F);
		...
		bodyModel[139].setRotationPoint(-9F, -22F, -11F);
		...
		bodyModel[140].setRotationPoint(-19F, -22F, 7F);
		...
		bodyModel[142].setRotationPoint(-16F, -11F, -11F);
		...
		bodyModel[143].setRotationPoint(-18F, -13F, -11F);

		bodyModel[144].addBox(0F, 0F, 0F, 1, 1, 0, 0F); // Box 314
		bodyModel[144].setRotationPoint(-19F, -13F, -11F);
		...
		bodyModel[154].setRotationPoint(-39.5F, -9.5F, -7F);

		bodyModel[155].addBox(0F, 0F, 0F, 0, 7, 1, 0F); // Box 43
		bodyModel[155].setRotationPoint(-39F, -7.5F, -7F);

		bodyModel[156].addBox(0F, 0F, 0F, 7, 13, 14, 0F); // Box 345
		bodyModel[156].setRotationPoint(-38F, -14F, -7F);

		bodyModel[157].addBox(0F, 0F, 0F, 2, 9, 1, 0F); // Box 346 cover
		bodyModel[157].setRotationPoint(-40F, -10F, -7F);
		...
		bodyModel[158].setRotationPoint(-3F, -22F, -9F);
		...
		bodyModel[159].setRotationPoint(-3F, -22F, 7F);
		...
		bodyModel[160].setRotationPoint(-8F, -22F, -9F);
		...
		bodyModel[161].setRotationPoint(10F, -22F, -9F);
		...
		bodyModel[162].setRotationPoint(10F, -22F, 7F);
		...
		bodyModel[163].setRotationPoint(-8F, -22F, 7F);

		bodyModel[164].addBox(0F, 0F, 0F, 3, 3, 0, 0F); // Box 355
		bodyModel[164].setRotationPoint(-40F, -13F, -7.5F);

		bodyModel[165].addBox(0F, 0F, 0F, 1, 1, 1, 0F); // Box 356
		bodyModel[165].setRotationPoint(-39F, -12F, -7.5F);
		...
		bodyModel[166].setRotationPoint(12F, -23.5F, -6F);

		bodyModel[167].addBox(0F, 0F, 0F, 2, 1, 1, 0F); // Box 380
		bodyModel[167].setRotationPoint(11F, -24.5F, -5.75F);

		bodyModel[168].addBox(0F, 0F, 0F, 3, 1, 1, 0F); // Box 381
		bodyModel[168].setRotationPoint(10F, -24.5F, -4.25F);

		bodyModel[169].addBox(0F, 0F, 0F, 3, 1, 1, 0F); // Box 384
		bodyModel[169].setRotationPoint(-33.75F, -24F, -1.5F);

		bodyModel[170].addBox(0F, 0F, 0F, 2, 1, 1, 0F); // Box 385
		bodyModel[170].setRotationPoint(-32.25F, -24F, -0.5F);

		bodyModel[171].addBox(0F, 0F, 0F, 2, 1, 1, 0F); // Box 386
		bodyModel[171].setRotationPoint(-33F, -24F, 0.5F);

		bodyModel[172].addBox(0F, 0F, 0F, 1, 2, 1, 0F); // Box 387
		bodyModel[172].setRotationPoint(-32F, -23.5F, -0.5F);

		bodyModel[173].addBox(0F, 0F, 0F, 5, 2, 8, 0F); // Box 388
		bodyModel[173].setRotationPoint(-28F, -23.5F, -4F);

		bodyModel[174].addBox(0F, 0F, 0F, 2, 0, 2, 0F); // Box 389
		bodyModel[174].setRotationPoint(-30F, -23F, -9F);

		bodyModel[175].addBox(0F, 0F, 0F, 2, 3, 0, 0F); // Box 390
		bodyModel[175].setRotationPoint(-30F, -23F, -9F);

		bodyModel[176].addBox(0F, 0F, 0F, 2, 1, 0, 0F); // Box 391
		bodyModel[176].setRotationPoint(-30F, -23F, -7F);
		...
		bodyModel[177].setRotationPoint(-29.5F, -25F, -8.5F);
		...
		bodyModel[178].setRotationPoint(-29.32F, -24F, -8.5F);
		...
		bodyModel[179].setRotationPoint(-15F, 2F, -10.5F);
		...
		bodyModel[180].setRotationPoint(-15F, 1F, -10.5F);
		...
		bodyModel[181].setRotationPoint(-14.75F, 2.5F, -10.25F);
		...
		bodyModel[182].setRotationPoint(-49F, -3F, 4.75F);
		...
		bodyModel[183].setRotationPoint(-49F, -3F, -6.75F);

		bodyModel[184].addShapeBox(0F, 0F, 0F, 1, 2, 2, 0F,0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F); // Box 189 ditchlight front
		bodyModel[184].setRotationPoint(-49.25F, -3F, 4.75F);

		bodyModel[185].addShapeBox(0F, 0F, 0F, 1, 2, 2, 0F,0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F); // Box 190 ditchlight front
		bodyModel[185].setRotationPoint(-49.25F, -3F, -6.75F);
		...
		bodyModel[186].setRotationPoint(49F, -3F, -6.75F);

		bodyModel[187].addShapeBox(0F, 0F, 0F, 1, 2, 2, 0F,-0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F); // Box 240 ditchlight rear
		bodyModel[187].setRotationPoint(49.25F, -3F, -6.75F);

		bodyModel[188].addShapeBox(0F, 0F, 0F, 1, 2, 2, 0F,-0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F); // Box 241ditchlight rear
		bodyModel[188].setRotationPoint(49.25F, -3F, 4.75F);
		...
		bodyModel[189].setRotationPoint(49F, -3F, 4.75F);
		...
		bodyModel[190].setRotationPoint(-30.32F, -23F, -0.5F);
		...
		bodyModel[191].setRotationPoint(-30.5F, -24F, -0.5F);

		bodyModel[192].addBox(0F, 0F, 0F, 2, 1, 4, 0F); // Box 411
		bodyModel[192].setRotationPoint(-30F, 1F, -11F);

		bodyModel[193].addBox(0F, 0F, 0F, 2, 1, 4, 0F); // Box 412
		bodyModel[193].setRotationPoint(-30F, 1F, 7F);

		bodyModel[194].addBox(0F, 0F, 0F, 2, 1, 4, 0F); // Box 413
		bodyModel[194].setRotationPoint(27F, 1F, 7F);

		bodyModel[195].addBox(0F, 0F, 0F, 2, 1, 4, 0F); // Box 414
		bodyModel[195].setRotationPoint(27F, 1F, -11F);
		...
		bodyModel[196].setRotationPoint(-27F, -23F, 0F);

		bodyModel[197].addShapeBox(0F, 0F, 0F, 1, 2, 2, 0F,0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F); // Box 416 ditchlight front
		bodyModel[197].setRotationPoint(-49.75F, 0F, -5.75F);
		...
		bodyModel[198].setRotationPoint(-49.5F, 0F, -5.75F);

		bodyModel[199].addShapeBox(0F, 0F, 0F, 1, 2, 2, 0F,0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F); // Box 418 ditchlight front
		bodyModel[199].setRotationPoint(-49.75F, 0F, 3.75F);
		...
		bodyModel[200].setRotationPoint(-49.5F, 0F, 3.75F);
		...
		bodyModel[201].setRotationPoint(-29F, -19F, 11F);
		...
		bodyModel[202].setRotationPoint(-29F, -19F, -12F);

		bodyModel[203].addBox(0F, 0F, 0F, 0, 4, 1, 0F); // Box 350
		bodyModel[203].setRotationPoint(-28F, -17F, -12F);

		bodyModel[204].addBox(0F, 0F, 0F, 0, 4, 1, 0F); // Box 351
		bodyModel[204].setRotationPoint(-28F, -17F, 11F);

		bodyModel[205].addBox(0F, 0F, 0F, 2, 2, 4, 0F); // Box 336
		bodyModel[205].setRotationPoint(-33F, -24F, -2F);
		...
		bodyModel[206].setRotationPoint(-33.75F, -24F, 0F);
		...
		bodyModel[207].setRotationPoint(-33.75F, -24F, -2F);

		bodyModel[208].addBox(0F, 0F, 0F, 4, 1, 1, 0F); // Box 327
		bodyModel[208].setRotationPoint(3.5F, -23.5F, -8.5F);

		bodyModel[209].addBox(0F, 0F, 0F, 3, 1, 1, 0F); // Box 328
		bodyModel[209].setRotationPoint(4.5F, -23.25F, -7.5F);

		bodyModel[210].addBox(0F, 0F, 0F, 3, 1, 1, 0F); // Box 329
		bodyModel[210].setRotationPoint(4F, -23.25F, -9.5F);

		bodyModel[211].addBox(0F, 0F, 0F, 1, 1, 1, 0F); // Box 330
		bodyModel[211].setRotationPoint(6F, -22.5F, -8.5F);

		bodyModel[212].addBox(0F, 0F, 0F, 2, 1, 1, 0F); // Box 331
		bodyModel[212].setRotationPoint(5F, -24.5F, -7.75F);

		bodyModel[213].addBox(0F, 0F, 0F, 2, 1, 1, 0F); // Box 332
		bodyModel[213].setRotationPoint(5F, -24.5F, -9F);
		...
		bodyModel[227].setRotationPoint(-26.5F, -24F, -0.5F);
		...
		bodyModel[228].setRotationPoint(-26.32F, -23F, -0.5F);

		bodyModel[229].addBox(0F, 0F, 0F, 2, 1, 2, 0F); // Box 629
		bodyModel[229].setRotationPoint(-28F, 3F, -1F);

		bodyModel[230].addBox(0F, 0F, 0F, 2, 1, 2, 0F); // Box 630
		bodyModel[230].setRotationPoint(-35F, 3F, -1F);

		bodyModel[231].addBox(0F, 0F, 0F, 2, 1, 2, 0F); // Box 726
		bodyModel[231].setRotationPoint(32F, 3F, -1F);

		bodyModel[232].addBox(0F, 0F, 0F, 2, 1, 2, 0F); // Box 727
		bodyModel[232].setRotationPoint(25F, 3F, -1F);

		bodyModel[233].addBox(0F, 0F, 0F, 4, 0, 4, 0F); // Box 369
		bodyModel[233].setRotationPoint(-20F, -24F, 2F);

		bodyModel[234].addBox(0F, 0F, 0F, 1, 2, 0, 0F); // Box 370
		bodyModel[234].setRotationPoint(-20F, -24F, 2F);

		bodyModel[235].addBox(0F, 0F, 0F, 1, 2, 0, 0F); // Box 371
		bodyModel[235].setRotationPoint(-20F, -24F, 6F);
		...
		bodyModel[236].setRotationPoint(-20F, -25F, 4F);

		bodyModel[237].addBox(0F, 0F, 0F, 1, 2, 0, 0F); // Box 373
		bodyModel[237].setRotationPoint(-17F, -24F, 6F);

		bodyModel[238].addBox(0F, 0F, 0F, 1, 1, 0, 0F); // Box 374
		bodyModel[238].setRotationPoint(-17F, -24F, 2F);
		...
		bodyModel[239].setRotationPoint(49F, -1F, -11F);
		...
		bodyModel[240].setRotationPoint(21F, -22F, -8F);
		...
		bodyModel[241].setRotationPoint(21F, -22F, 7F);
		...
		bodyModel[242].setRotationPoint(21F, -24F, -8F);
		...
		bodyModel[243].setRotationPoint(21F, -24F, 0F);

		bodyModel[244].addBox(0F, 0F, 0F, 19, 8, 1, 0F); // Box 369
		bodyModel[244].setRotationPoint(25F, -9.5F, -7.5F);

		bodyModel[245].addBox(0F, 0F, 0F, 19, 8, 1, 0F); // Box 370
		bodyModel[245].setRotationPoint(25F, -9.5F, 6.5F);

		bodyModel[246].addBox(0F, 0F, 0F, 4, 0, 2, 0F); // Box 372
		bodyModel[246].setRotationPoint(44F, 4.5F, 9F);

		bodyModel[247].addBox(0F, 0F, 0F, 0, 6, 2, 0F); // Box 373
		bodyModel[247].setRotationPoint(44F, 1F, 9F);

		bodyModel[248].addBox(0F, 0F, 0F, 4, 0, 2, 0F); // Box 374
		bodyModel[248].setRotationPoint(44F, 2F, 9F);

		bodyModel[249].addBox(0F, 0F, 0F, 4, 0, 2, 0F); // Box 375
		bodyModel[249].setRotationPoint(44F, -1F, 9F);

		bodyModel[250].addBox(0F, 0F, 0F, 4, 0, 2, 0F); // Box 376
		bodyModel[250].setRotationPoint(44F, 7F, 9F);
		...
		bodyModel[251].setRotationPoint(48F, 4F, 2F);
		...
		bodyModel[252].setRotationPoint(48F, 4F, -10F);
		...
		bodyModel[253].setRotationPoint(-52F, 4F, 2F);
		...
		bodyModel[254].setRotationPoint(-52F, 4F, -10F);

		bodyModel[255].addBox(0F, 0F, 0F, 2, 6, 4, 0F); // Box 381 sp mount
		bodyModel[255].setRotationPoint(44F, -23F, -2F);

		bodyModel[256].addBox(0F, 0F, 0F, 23, 1, 16, 0F); // Box 382
		bodyModel[256].setRotationPoint(21F, -23F, -8F);

		bodyModel[257].addBox(0F, 0F, 0F, 1, 2, 4, 0F); // Box 31 sp mount
		bodyModel[257].setRotationPoint(46F, -21F, -2F);
		...
		bodyModel[258].setRotationPoint(46.25F, -21F, -2F);
		...
		bodyModel[259].setRotationPoint(46.25F, -21F, 0F);
		...
		bodyModel[260].setRotationPoint(45.25F, -19F, 0F);
		...
		bodyModel[261].setRotationPoint(45.25F, -19F, -2F);
		...
		bodyModel[268].setRotationPoint(-44F, -9F, -7F);
		...
		bodyModel[269].setRotationPoint(-44F, -9F, 0F);
		...
		bodyModel[270].setRotationPoint(-44F, -11F, 1F);
		...
		bodyModel[271].setRotationPoint(-42.98F, -14F, -1F);
		...
		bodyModel[272].setRotationPoint(-44F, -11F, -1F);
		...
		bodyModel[273].setRotationPoint(-44F, -13F, -1F);
		...
		bodyModel[274].setRotationPoint(-44F, -14F, 0F);
		...
		bodyModel[275].setRotationPoint(-44F, -11F, -7F);
		...
		bodyModel[276].setRotationPoint(-44F, -14F, -1F);
		...
		bodyModel[277].setRotationPoint(-44F, -14F, 1F);
		...
		bodyModel[278].setRotationPoint(-44F, -14F, -7F);
		...
		bodyModel[279].setRotationPoint(-43.75F, -13F, -2F);
		...
		bodyModel[280].setRotationPoint(-43.75F, -13F, 0F);
		...
		bodyModel[281].setRotationPoint(-43.75F, -15F, -1F);
		...
		bodyModel[282].setRotationPoint(-42.98F, -15F, -1.5F);
		...
		bodyModel[283].setRotationPoint(-43.15F, -14F, -2F);

		bodyModel[284].addBox(0F, 0F, 0F, 1, 2, 0, 0F); // Box 297
		bodyModel[284].setRotationPoint(-29F, -24F, 0F);

		bodyModel[285].addBox(0F, 0F, 0F, 1, 4, 2, 0F); // Box 298 drgw mount
		bodyModel[285].setRotationPoint(45F, -22F, -1F);
		...
		bodyModel[286].setRotationPoint(45.25F, -22F, -1F);
		...
		bodyModel[287].setRotationPoint(45.25F, -20F, -1F);
		...
		bodyModel[288].setRotationPoint(-32.32F, -23F, -0.5F);
		...
		bodyModel[289].setRotationPoint(-32.5F, -24F, -0.5F);

		bodyModel[290].addBox(0F, 0F, 0F, 2, 1, 1, 0F); // Box 303
		bodyModel[290].setRotationPoint(-30.5F, -24F, 2.5F);

		bodyModel[291].addBox(0F, 0F, 0F, 1, 2, 1, 0F); // Box 304
		bodyModel[291].setRotationPoint(-30.25F, -23.5F, 2.5F);

		bodyModel[292].addBox(0F, 0F, 0F, 2, 1, 1, 0F); // Box 305
		bodyModel[292].setRotationPoint(-31.25F, -24F, 3.5F);

		bodyModel[293].addBox(0F, 0F, 0F, 3, 1, 1, 0F); // Box 306
		bodyModel[293].setRotationPoint(-32F, -24F, 1.5F);

		bodyModel[294].addBox(0F, 0F, 0F, 3, 1, 1, 0F); // Box 307
		bodyModel[294].setRotationPoint(14F, -24F, -1.5F);

		bodyModel[295].addBox(0F, 0F, 0F, 2, 1, 1, 0F); // Box 308
		bodyModel[295].setRotationPoint(15.5F, -24F, -0.5F);

		bodyModel[296].addBox(0F, 0F, 0F, 1, 2, 1, 0F); // Box 309
		bodyModel[296].setRotationPoint(15.75F, -23.5F, -0.5F);

		bodyModel[297].addBox(0F, 0F, 0F, 2, 1, 1, 0F); // Box 310
		bodyModel[297].setRotationPoint(14.75F, -24F, 0.5F);
		...
		bodyModel[298].setRotationPoint(44F, -23F, -7F);
		...
		bodyModel[299].setRotationPoint(44F, -23F, 0F);

		bodyModel[300].addBox(0F, 0F, 0F, 2, 5, 3, 0F); // Box 313 drgw mount
		bodyModel[300].setRotationPoint(43.5F, -23F, -1.5F);

		bodyModel[301].addBox(0F, 0F, 0F, 2, 2, 18, 0F); // Box 314
		bodyModel[301].setRotationPoint(48F, 6F, -9F);
		...
		bodyModel[302].setRotationPoint(-30F, -23.5F, -6F);
		...
		bodyModel[303].setRotationPoint(-30F, -24.5F, -6F);

		bodyModel[304].addBox(0F, 0F, 0F, 0, 1, 3, 0F); // Box 323
		bodyModel[304].setRotationPoint(-29.5F, -25F, -5.75F);

		bodyModel[305].addBox(0F, 0F, 0F, 0, 2, 1, 0F); // Box 324
		bodyModel[305].setRotationPoint(-29.5F, -24F, -3.75F);
		...
		bodyModel[307].setRotationPoint(-49F, 4F, -10F);

		bodyModel[308].addBox(0F, 0F, 0F, 4, 1, 0, 0F); // Box 275
		bodyModel[308].setRotationPoint(-49F, 6F, -9F);

		bodyModel[309].addBox(0F, 0F, 0F, 4, 1, 0, 0F); // Box 276
		bodyModel[309].setRotationPoint(-49F, 3F, -8F);

		bodyModel[310].addBox(0F, 0F, 0F, 4, 1, 0, 0F); // Box 329
		bodyModel[310].setRotationPoint(44F, 6F, -9F);

		bodyModel[311].addBox(0F, 0F, 0F, 4, 1, 0, 0F); // Box 330
		bodyModel[311].setRotationPoint(44F, 3.5F, -9F);

		bodyModel[312].addBox(0F, 0F, 0F, 4, 1, 0, 0F); // Box 331
		bodyModel[312].setRotationPoint(44F, 3.5F, 9F);

		bodyModel[313].addBox(0F, 0F, 0F, 4, 1, 0, 0F); // Box 332
		bodyModel[313].setRotationPoint(44F, 6F, 9F);

		bodyModel[314].addBox(0F, 0F, 0F, 4, 1, 0, 0F); // Box 333
		bodyModel[314].setRotationPoint(-49F, 6F, 9F);
		...
		bodyModel[315].setRotationPoint(-49F, 7F, 9F);
		...
		bodyModel[316].setRotationPoint(-49F, 4F, 8F);

		bodyModel[317].addBox(0F, 0F, 0F, 4, 1, 0, 0F); // Box 336
		bodyModel[317].setRotationPoint(-49F, 3F, 8F);

		bodyModel[318].addShapeBox(0F, 0F, 0F, 1, 2, 2, 0F,-0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F); // Box 337 ditchlight rear
		bodyModel[318].setRotationPoint(47.75F, 1F, 3.75F);
		...
		bodyModel[319].setRotationPoint(47.5F, 1F, 3.75F);
		...
		bodyModel[320].setRotationPoint(47.5F, 1F, -5.75F);

		bodyModel[321].addShapeBox(0F, 0F, 0F, 1, 2, 2, 0F,-0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F); // Box 340 ditchlight rear
		bodyModel[321].setRotationPoint(47.75F, 1F, -5.75F);

		bodyModel[322].addBox(0F, 0F, 0F, 3, 1, 1, 0F); // Box 341
		bodyModel[322].setRotationPoint(43F, -24.5F, 5.5F);

		bodyModel[323].addBox(0F, 0F, 0F, 1, 2, 1, 0F); // Box 342
		bodyModel[323].setRotationPoint(43.5F, -23.5F, 5.5F);
		...
		bodyModel[324].setRotationPoint(13.5F, -20.5F, 7.7F);
		...
		bodyModel[325].setRotationPoint(13.5F, -21.5F, 7.7F);
		...
		bodyModel[326].setRotationPoint(13.75F, -20F, 7.95F);
		...
		bodyModel[327].setRotationPoint(13.5F, -22.5F, 6.5F);
		...
		bodyModel[328].setRotationPoint(-25F, -29F, 6F);
		...
		bodyModel[329].setRotationPoint(-25F, -29F, 8F);
		...
		bodyModel[330].setRotationPoint(-25F, -28F, 5F);
		...
		bodyModel[331].setRotationPoint(-25F, -28F, 8F);
		...
		bodyModel[332].setRotationPoint(-25F, -26F, 7F);
		...
		bodyModel[333].setRotationPoint(-25F, -26F, 5F);
		...
		bodyModel[334].setRotationPoint(-25F, -26F, -8F);
		...
		bodyModel[335].setRotationPoint(-25F, -26F, -10F);
		...
		bodyModel[336].setRotationPoint(-25F, -28F, -9F);
		...
		bodyModel[337].setRotationPoint(-25F, -28F, -8F);
		...
		bodyModel[338].setRotationPoint(-25F, -29F, -8F);
		...
		bodyModel[339].setRotationPoint(-25F, -29F, -9F);

		bodyModel[340].addBox(0F, 0F, 0F, 0, 9, 14, 0F); // Box 340
		bodyModel[340].setRotationPoint(25F, -10F, -7F);

		bodyModel[341].addBox(0F, 0F, 0F, 19, 0, 14, 0F); // Box 341
		bodyModel[341].setRotationPoint(25F, -10F, -7F);

		bodyModel[342].addBox(0F, 0F, 0F, 0, 9, 14, 0F); // Box 342
		bodyModel[342].setRotationPoint(44F, -10F, -7F);
	}
	...
	public ModelRendererTurbo SD40T2Model[];
}