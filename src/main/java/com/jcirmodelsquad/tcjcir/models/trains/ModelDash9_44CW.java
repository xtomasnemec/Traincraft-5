//mario eh eh eh
package com.jcirmodelsquad.tcjcir.models.trains; //Path where your ass is located

import com.jcirmodelsquad.tcjcir.models.cabs.ModelD9_Cab4Window;
...
public class ModelDash9_44CW extends ModelConverter //Same as my ass
{
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
		...
		if (entity instanceof AbstractTrains && ((AbstractTrains) entity).getColor() == 7) {
			Tessellator.bindTexture(new ResourceLocation(Info.resourceLocation, "textures/trains/newgevotruck_Black.png")); //supposed to be LightGrey, is black for testing
			GL11.glPushMatrix();
