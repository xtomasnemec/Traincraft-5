...
public class ModelSW1 extends ModelConverter //Same as Filename
{
	...
	ModelTypeAClassico theTrucks1 = new ModelTypeAClassico();
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        if (entity instanceof AbstractTrains && ((AbstractTrains) entity).getColor() == 15) {
            ...
            Tessellator.bindTexture(new ResourceLocation(Info.resourceLocation, "textures/trains/typeAclassico_Silver.png"));// replace with grey eventually
			GL11.glPushMatrix();
