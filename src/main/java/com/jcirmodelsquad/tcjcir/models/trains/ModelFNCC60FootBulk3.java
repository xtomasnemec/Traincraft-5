...
public class ModelFNCC60FootBulk3 extends ModelConverter //Same as Filename
{
	int textureX = 256;
	int textureY = 256;

	public ModelFNCC60FootBulk3() //Same as Filename
	{
		...
		bodyModel[90].addShape3D(0F, 0F, 0F, new Shape2D(new Coord2D[] { new Coord2D(0, 0, 0, 0), new Coord2D(3, 0, 3, 0), new Coord2D(3, 12, 3, 12) }), 2, 3, 12, 28, 2, ModelRendererTurbo.MR_FRONT, new float[] {13 ,12 ,3}); // Shape 124
		...
		bodyModel[92].addShape3D(0F, 0F, 0F, new Shape2D(new Coord2D[] { new Coord2D(0, 0, 0, 0), new Coord2D(3, 0, 3, 0), new Coord2D(3, 12, 3, 12) }), 2, 3, 12, 28, 2, ModelRendererTurbo.MR_FRONT, new float[] {13 ,12 ,3}); // Shape 127
		bodyModel[92].setRotationPoint(42.5F, -7F, 1F);

		bodyModel[93].addShape3D(0F, 0F, 0F, new Shape2D(new Coord2D[] { new Coord2D(0, 0, 0, 0), new Coord2D(3, 0, 3, 0), new Coord2D(3, 12, 3, 12) }), 2, 3, 12, 28, 2, ModelRendererTurbo.MR_FRONT, new float[] {13 ,12 ,3}); // Shape 128
