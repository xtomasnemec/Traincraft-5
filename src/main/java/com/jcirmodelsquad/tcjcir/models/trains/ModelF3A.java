...
public class ModelF3A extends ModelConverter //Same as Filename
{
	...
	public ModelF3A() //Same as Filename
	{
		...
		bodyModel[154] = new ModelRendererTurbo(this, 84, 60, textureX, textureY); // Box 164 lamp
		bodyModel[155] = new ModelRendererTurbo(this, 70, 60, textureX, textureY); // Box 165 lamp
		bodyModel[156] = new ModelRendererTurbo(this, 70, 58, textureX, textureY); // Box 166 lamp
		bodyModel[157] = new ModelRendererTurbo(this, 84, 58, textureX, textureY); // Box 167 lamp
		bodyModel[158] = new ModelRendererTurbo(this, 72, 66, textureX, textureY); // Box 168 lamp
		bodyModel[159] = new ModelRendererTurbo(this, 82, 66, textureX, textureY); // Box 169 lamp
		bodyModel[160] = new ModelRendererTurbo(this, 82, 68, textureX, textureY); // Box 170 lamp
		bodyModel[161] = new ModelRendererTurbo(this, 72, 68, textureX, textureY); // Box 171 lamp
		...
		bodyModel[171] = new ModelRendererTurbo(this, 146, 40, textureX, textureY); // Box 348 rotating lamp?
		...
		bodyModel[174] = new ModelRendererTurbo(this, 114, 55, textureX, textureY); // Box 184 liveryimg 2 glow
		bodyModel[175] = new ModelRendererTurbo(this, 32, 55, textureX, textureY); // Box 185 liveryimg 2 glow
		...
		bodyModel[221] = new ModelRendererTurbo(this, 323, 33, textureX, textureY); // Box 247 lamp
		...
		bodyModel[227] = new ModelRendererTurbo(this, 70, 18, textureX, textureY); // Box 337 lamp
		bodyModel[228] = new ModelRendererTurbo(this, 80, 18, textureX, textureY); // Box 338 lamp
		bodyModel[229] = new ModelRendererTurbo(this, 85, 86, textureX, textureY); // Box 443 lamp
		bodyModel[230] = new ModelRendererTurbo(this, 80, 89, textureX, textureY); // Box 444
		bodyModel[231] = new ModelRendererTurbo(this, 65, 86, textureX, textureY); // Box 445 lamp
		...
		bodyModel[267] = new ModelRendererTurbo(this, 107, 66, textureX, textureY); // Marker light fireman glow number b
		bodyModel[268] = new ModelRendererTurbo(this, 45, 66, textureX, textureY); // Marker light engneer glow number b
		bodyModel[269] = new ModelRendererTurbo(this, 104, 57, textureX, textureY); // Marker light fireman glow top
		bodyModel[270] = new ModelRendererTurbo(this, 48, 60, textureX, textureY); // Marker light engneer glow
		bodyModel[271] = new ModelRendererTurbo(this, 104, 60, textureX, textureY); // Marker light fireman glow
		bodyModel[272] = new ModelRendererTurbo(this, 48, 57, textureX, textureY); // Marker light engneer glow top
		bodyModel[273] = new ModelRendererTurbo(this, 33, 68, textureX, textureY); // Box 144 liveryimg 2 glow
		bodyModel[274] = new ModelRendererTurbo(this, 119, 68, textureX, textureY); // Box 111 liveryimg 2 glow
		bodyModel[275] = new ModelRendererTurbo(this, 82, 103, textureX, textureY); // Box 445 lamp
		bodyModel[276] = new ModelRendererTurbo(this, 75, 101, textureX, textureY); // Box 446
		bodyModel[277] = new ModelRendererTurbo(this, 68, 103, textureX, textureY); // Box 445 lamp
