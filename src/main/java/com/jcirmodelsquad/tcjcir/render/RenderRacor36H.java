...
public class RenderRacor36H extends TileEntitySpecialRenderer {
    private static final ModelRacor36H_On modelSwitch2 = new ModelRacor36H_On();
    private static final ModelRacor36H_Off modelSwitch = new ModelRacor36H_Off();
    private static final ResourceLocation texture2 = new ResourceLocation(Info.resourceLocation,Info.modelTexPrefix + "Racor36H.png");
    ...
    public void renderTileEntityAt(TileEntity tileEntity, double x, double y, double z, float tick) {
        ...
        switch (((TileRacor36H)tileEntity).getFacing()){
            case NORTH:{
