...
public class ModelRacor36D_Off extends ModelConverter //Same as Filename
{
	int textureX = 128;
	int textureY = 32;

	public ModelRacor36D_Off() //Same as Filename
	{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[22] = new ModelRendererTurbo(this, 52, 13, textureX, textureY); // Box 27
		bodyModel[23] = new ModelRendererTurbo(this, 53, 10, textureX, textureY); // Box 28
		bodyModel[24] = new ModelRendererTurbo(this, 53, 10, textureX, textureY); // Box 29
		bodyModel[25] = new ModelRendererTurbo(this, 53, 10, textureX, textureY); // Box 30
		bodyModel[26] = new ModelRendererTurbo(this, 52, 13, textureX, textureY); // Box 31
		bodyModel[27] = new ModelRendererTurbo(this, 53, 10, textureX, textureY); // Box 32
		bodyModel[28] = new ModelRendererTurbo(this, 12, 17, textureX, textureY); // Box 26 target b
		bodyModel[29] = new ModelRendererTurbo(this, 12, 9, textureX, textureY); // Box 47 target a
		...
		bodyModel[28].addShapeBox(-0.75F, 0F, -2.5F, 1, 2, 5, 0F,-0.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.5F, 0F, 0F); // Box 26 target b
		bodyModel[28].setRotationPoint(-1.5F, 2F, 0F);

		bodyModel[29].addShapeBox(-0.75F, 0F, -2.5F, 1, 2, 5, 0F,-0.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.5F, 0F, 0F); // Box 47 target a
		bodyModel[29].setRotationPoint(-1.5F, 2F, 0F);
