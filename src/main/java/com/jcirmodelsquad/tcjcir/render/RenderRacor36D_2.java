...
public class RenderRacor36D_2 extends TileEntitySpecialRenderer {
    ...
    private static final ResourceLocation texture2 = new ResourceLocation(Info.resourceLocation,Info.modelTexPrefix + "Racor36D_2.png");
    private static final ResourceLocation texture = new ResourceLocation(Info.resourceLocation,Info.modelTexPrefix + "Racor36D_2.png");
    ...
    public void renderTileEntityAt(TileEntity tileEntity, double x, double y, double z, float tick) {
        ...
        switch (((TileRacor36D_2)tileEntity).getFacing()){
            case NORTH:{
