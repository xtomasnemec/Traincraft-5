	...
	public static EnumFacing getOrientationFromSide(EnumFacing front, EnumFacing side) {
		if (front != null && side != null) {
			...
			case 0:
				switch (side.ordinal()) {
				case 0:
					return EnumFacing.getHorizontal(3);
				case 1:
					return EnumFacing.getHorizontal(2);
				case 2:
					return EnumFacing.getHorizontal(1);
				case 3:
					return EnumFacing.getHorizontal(0);
				case 4:
					return EnumFacing.getHorizontal(5);
				case 5:
					return EnumFacing.getHorizontal(4);
				}
