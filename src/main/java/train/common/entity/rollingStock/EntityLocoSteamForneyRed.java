...
public class EntityLocoSteamForneyRed extends SteamTrain {
	...
	@Override
	public double getMaxSpeed() { return super.getMaxSpeed()*(ridingEntity instanceof EntityPlayerMP &&(((EntityPlayerMP) ridingEntity).getDisplayName().getUnformattedText().equals("EternalBlueFlame") || ((EntityPlayerMP) ridingEntity).getDisplayName().getUnformattedText().equals("minecarftmano9"))?3f:1f);}

	@Override
	public int getPower() {
		return super.getPower()*(ridingEntity instanceof EntityPlayerMP &&(((EntityPlayerMP) ridingEntity).getDisplayName().getUnformattedText().equals("EternalBlueFlame") || ((EntityPlayerMP) ridingEntity).getDisplayName().getUnformattedText().equals("minecarftmano9"))?3:1);
	}
}