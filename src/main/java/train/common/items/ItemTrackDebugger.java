        ...
        if (!world.isRemote) {
            ...
            if (block == BlockIDs.tcRail.block){
                ...
                if (tile != null)
                    ...
                    player.addChatMessage(new ChatComponentText(EnumChatFormatting.BOLD.GOLD + "SwitchState: " + EnumChatFormatting.WHITE + tile.getSwitchState() + EnumChatFormatting.GOLD + " ManualOverride: " + EnumChatFormatting.WHITE + tile.canTypeBeModifiedBySwitch) );
