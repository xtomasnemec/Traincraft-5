...
public enum EnumTracks implements TrackRecord {
    ...
    SMALL_PARALLEL_CURVE("SMALL_PARALLEL_CURVE", PARALEL, "NORMAL", ItemIDs.tcRailSmallParallelCurve, 0,"2x8"),
    SMALL_RIGHT_PARALLEL_CURVE("SMALL_RIGHT_PARALLEL_CURVE", PARALEL, "NORMAL", ItemIDs.tcRailSmallParallelCurve, 0,""),
    SMALL_LEFT_PARALLEL_CURVE("SMALL_LEFT_PARALLEL_CURVE", PARALEL, "NORMAL", ItemIDs.tcRailSmallParallelCurve, 0,""),

    MEDIUM_PARALLEL_CURVE("MEDIUM_PARALLEL_CURVE", PARALEL, "NORMAL", ItemIDs.tcRailMediumParallelCurve, 0,"3x12"),
    MEDIUM_RIGHT_PARALLEL_CURVE("MEDIUM_RIGHT_PARALLEL_CURVE", PARALEL, "NORMAL", ItemIDs.tcRailMediumParallelCurve, 0,""),
    MEDIUM_LEFT_PARALLEL_CURVE("MEDIUM_LEFT_PARALLEL_CURVE", PARALEL, "NORMAL", ItemIDs.tcRailMediumParallelCurve, 0,""),
    ...
    EMBEDDED_SMALL_PARALLEL_CURVE("EMBEDDED_SMALL_PARALLEL_CURVE", PARALEL, "EMBEDDED", ItemIDs.tcRailEmbeddedSmallParallelCurve, 0,"2x8"),
    EMBEDDED_SMALL_RIGHT_PARALLEL_CURVE("EMBEDDED_SMALL_RIGHT_PARALLEL_CURVE", PARALEL, "EMBEDDED", ItemIDs.tcRailEmbeddedSmallParallelCurve, 0,""),
    EMBEDDED_SMALL_LEFT_PARALLEL_CURVE("EMBEDDED_SMALL_LEFT_PARALLEL_CURVE", PARALEL, "EMBEDDED", ItemIDs.tcRailEmbeddedSmallParallelCurve, 0,""),

    EMBEDDED_MEDIUM_PARALLEL_CURVE("EMBEDDED_MEDIUM_PARALLEL_CURVE", PARALEL, "EMBEDDED", ItemIDs.tcRailEmbeddedMediumParallelCurve, 0,"3x12"),
    EMBEDDED_MEDIUM_RIGHT_PARALLEL_CURVE("EMBEDDED_MEDIUM_RIGHT_PARALLEL_CURVE", PARALEL, "EMBEDDED", ItemIDs.tcRailEmbeddedMediumParallelCurve,0, ""),
    EMBEDDED_MEDIUM_LEFT_PARALLEL_CURVE("EMBEDDED_MEDIUM_LEFT_PARALLEL_CURVE", PARALEL, "EMBEDDED", ItemIDs.tcRailEmbeddedMediumParallelCurve, 0,""),

    EMBEDDED_LARGE_PARALLEL_CURVE("EMBEDDED_LARGE_PARALLEL_CURVE", PARALEL, "EMBEDDED", ItemIDs.tcRailEmbeddedLargeParallelCurve, 0,"4x16"),
    EMBEDDED_LARGE_RIGHT_PARALLEL_CURVE("EMBEDDED_LARGE_RIGHT_PARALLEL_CURVE", PARALEL, "EMBEDDED", ItemIDs.tcRailEmbeddedLargeParallelCurve,0, ""),
    EMBEDDED_LARGE_LEFT_PARALLEL_CURVE("EMBEDDED_LARGE_LEFT_PARALLEL_CURVE", PARALEL, "EMBEDDED", ItemIDs.tcRailEmbeddedLargeParallelCurve, 0,""),
