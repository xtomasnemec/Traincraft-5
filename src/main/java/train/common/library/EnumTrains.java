...
public enum EnumTrains {
	...
	PS140("PS140", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.PS140.class, ItemIDs.minecartPS140.item, "freight", 4, new String[] {"Brown", "Red", "LightBlue"}, 0, 27, new String[]{"Made by Prof_Binky"}),
