...
public enum EnumTrains {
	...
	tankWagonUS("Tank Wagon US", EntityTankWagonUS.class, ItemIDs.minecartTankWagonUS.item, "tank", 0, 0, 6, 0, 0, 0, 0, 0, 70000, (new String[]{"Black", "Grey", "Yellow", "White", "LightGrey", "Green", "Blue", "Lime", "Orange", "Cyan", "Pink", "Purple", "LightBlue", "Magenta","Red"}), 18, 0, new String[]{"Capacity: 70000mb"}),
	...
	GP7u("GP7u", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselGP7u.class, ItemIDs.minecartGP7u.item, "diesel", 1500, 100, 0, 55, 0, 170, 0.81, 0.93, 10000, new String[] {"Red", "Blue", "LightGrey"}, 10, -3, new String[] {"Rebuilt by Bida"}),
	...
	Freight73centerbeam("73centerbeam", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.Freight73centerbeam.class, ItemIDs.minecart73centerbeam.item, "freight", 7, new String[] {"Pink", "Cyan"}, 0, 54, new String[]{"Made by Prof_Binky"}),
