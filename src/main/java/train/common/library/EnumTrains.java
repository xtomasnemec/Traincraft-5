...
public enum EnumTrains {
	...
	CF7("CF7", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselCF7.class, ItemIDs.minecartCF7.item, "diesel", 1500, 116, 0, 5, 0, 185, 0.8, 0.9, 5000, new String[] {"Yellow", "Red", "LightGrey", "White", "Cyan", "Lime", "Magenta", "Purple", "Green", "Blue", "Orange", "Pink", "Black", "Brown"}, 10, -3, new String[] {"Model version: 4.7"}),
	...
	SDL39("SDL39", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselSDL39.class, ItemIDs.minecartSDL39.item, "diesel", 2300, 152, 0, 5, 0, 180, 0.8, 0.9, 7000, new String[] {"Orange", "Blue", "Red"}, 10, -3, new String[] {"model by binky"}),
	...
	GP38dash2("GP38dash2", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselGP38dash2.class, ItemIDs.minecartGP38dash2.item, "diesel", 2000, 105, 0, 5, 0, 180, 0.75, 0.9, 7000, new  String[] {"Cyan", "Green", "LightGrey", "Red", "Blue", "Yellow", "Orange", "Grey", "Black"}, 10, -3.1),
	...
	GP15("GP15", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselGP15.class, ItemIDs.minecartGP15.item, "diesel", 1800, 105, 0, 5, 0, 160, 0.79, 0.93, 9000, new  String[] {"Yellow", "White", "LightGrey"}, 10, -2.6),
