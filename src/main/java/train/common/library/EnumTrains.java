...
public enum EnumTrains {
	...
	U23B("U23B", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselU23B.class, ItemIDs.minecartU23B.item, "diesel", 2250, 70, 0, 55, 0, 180, 0.7, 0.91, 18000, new String[] {"Grey", "Orange", "LightGrey", "Pink", "Lime", "Blue", "LightBlue", "Black", "Green","Purple", "Brown", "Yellow"}, 10, -3.3, new String[] {"Made by Bida"}),
	...
	C424("C424", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselC424.class, ItemIDs.minecartC424.item, "diesel", 2400, 113, 0, 60, 0, 190, 0.7, 0.8, 19000, new String[]{"Yellow", "Orange", "Cyan", "Red"}, 10, -3.6, new String[] {"Yet Another Bida Model kek"}),
	...
	GP7u("GP7u", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselGP7u.class, ItemIDs.minecartGP7u.item, "diesel", 1500, 100, 0, 55, 0, 170, 0.81, 0.93, 10000, new String[] {"Red", "Blue", "LightGrey", "Grey", "White", "Yellow"}, 10, -3, new String[] {"Rebuilt by Bida"}),
