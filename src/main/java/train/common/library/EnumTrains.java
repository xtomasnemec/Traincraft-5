...
public enum EnumTrains {
	...
	passengerRheingold("Passenger Rheingold", EntityPassengerRheingold.class, ItemIDs.minecartPassengerRheingold.item, "passenger", 0, 0, 1, 0, 0, 0, 0, 0, 0, new String[]{"Blue", "Red", "Green", "LightBlue", "Magenta", "Lime", "CyaN"}, 18, 0),
	...
	freightDepressedFlatbed("Freight Depressed Flatcar", EntityFreightDepressedFlatbed.class, ItemIDs.minecartFreightDepressedFlatbed.item, "freight", 0.1, (new String[]{"Black", "Grey", "LightGrey", "Blue", "Yellow", "White"}), 18, 36,new String[]{"Cargo: any"}),
	...
	Model225Tender("1225 tender",EntityTenderBerk1225.class, ItemIDs.minecarttenderBerk1225.item,"tender",0,0,2,0,0,0,0,0,15000,new String[]{"Black", "Grey","LightGrey"},18,0,new String[] {"Water capacity: 15000mb"}),
	...
	locoElectricBR185("Loco Electric BR 185", EntityLocoElectricBR185.class, ItemIDs.minecartLocoBR185.item, "electric", 2428, 160, 0, 6, 0, 170, 0.7, 0.965, 0, new String[]{"Red", "Blue", "Magenta", "Cyan", "Grey", "LightBlue", "LightGrey", "Orange", "Pink", "Purple", "White", "Yellow", "Black", "Brown","skin16"}, 18, -5),
	locoDieselE10lDB("Loco Electric E10 DB",EntityLocoElectricE10_DB.class, ItemIDs.minecartE10_DB.item,"electric",2473,150,0,8,0,170,0.66,0.96,8000,new String[] {"Blue","Red", "Grey", "Brown", "Green", "LightGrey", "Lime", "Pink", "Purple", "White","Cyan"},15,-3.8),
	...
	locosteamBerk1225("Loco Berkshire 1225", EntityLocoSteamBerk1225.class,  ItemIDs.minecartLocoBerk1225.item, "steam", 2775, 164, 0, 60, 200, 160, 0.65, 0.97, 10000, new String [] {"Black", "LightGrey"}, 7, -4.25 ),
	...
	/** JCIR-TC*/
	locoAlcoS2("Alco S2",  com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselAlcoS2.class, ItemIDs.minecartAlcoS2.item, "diesel", 1000, 96, 0, 45, 0, 170, 0.7, 0.965, 2500, new String[] {"Black", "Grey", "Green", "Orange", "Pink", "White", "Blue", "LightGrey", "Magenta", "Red"}, 18, -2),
	...
	SW1("SW1", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselSW1.class, ItemIDs.minecartSW1.item, "diesel", 600, 105, 0, 45, 0, 160, 0.6, 0.890, 2000, new String[] {"Orange", "Green", "Blue", "Black", "Pink", "Cyan", "LightGrey", "White"}, 10, -1.8),
	H1044("H1044", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselH1044.class, ItemIDs.minecartH1044.item, "diesel", 1000, 97, 0, 45, 0, 175, 0.75, 0.92, 3000, new String[]{"Green", "Yellow", "Black", "Red", "Blue", "Grey", "LightBlue", "Orange", "White", "Lime"}, 18, -2.2),
	...
	U23B("U23B", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselU23B.class, ItemIDs.minecartU23B.item, "diesel", 2250, 70, 0, 55, 0, 180, 0.7, 0.91, 6500, new String[] {"Grey", "Orange", "LightGrey", "Pink", "Lime", "Blue", "LightBlue", "Black", "Green","Purple", "Brown", "Yellow"}, 10, -3.3),
	SW1500("SW1500", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselSW1500.class, ItemIDs.minecartSW1500.item, "diesel", 1500, 105, 0, 50, 0, 180, 0.85, 0.97, 2000, new String[] {"LightBlue", "Blue", "Orange", "Pink", "White", "LightGrey"}, 10, -2.3),
	SD45dash2("SD45-2", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselSD45dash2.class, ItemIDs.minecartSD45dash2.item, "diesel", 3600, 132, 0, 65, 0, 190, 0.75, 0.89, 12000, new String[] {"Green", "White", "Black", "Orange", "Blue", "Pink", "Magenta", "LightBlue", "Yellow", "Grey","Red", "LightGrey", "Purple", "Brown", "Lime", "skin16"}, 10, -3.8),
	SD40dash2("SD40-2", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselSD40dash2.class, ItemIDs.minecartSD40dash2.item, "diesel", 3000, 105, 0, 60, 0, 190, 0.75, 0.89, 12000, new String[] {"LightGrey", "Orange", "Green", "Pink", "Magenta", "White", "Yellow", "Black", "Blue", "Red", "Lime", "Brown", "Purple"}, 10, -3.8),
	...
	CF7("CF7", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselCF7.class, ItemIDs.minecartCF7.item, "diesel", 1500, 116, 0, 45, 0, 185, 0.8, 0.9, 4500, new String[] {"Yellow", "Red", "LightGrey", "White", "Cyan", "Lime", "Magenta", "Purple", "Green", "Blue", "Orange", "Pink", "Black", "Brown"}, 10, -3, new String[] {"Model version: 4.7"}),
	CF7round("CF7round", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselCF7round.class, ItemIDs.minecartCF7round.item, "diesel", 1500, 116, 0, 45, 0, 185, 0.8, 0.9, 4500, new String[] {"Blue", "Yellow", "White", "Orange", "Pink"}, 10, -3, new String[] {"Rotunde Boye"}),
	SD9("SD9", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselSD9.class, ItemIDs.minecartSD9.item, "diesel", 1750, 104, 0, 50, 0, 190, 0.75, 0.89, 9000, new String[] {"Black", "Green", "Cyan", "Orange", "White"}, 10, -3.1),
	...
	SF30C("SF30C", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselSF30C.class, ItemIDs.minecartSF30C.item, "diesel", 3000, 121, 0, 55, 0, 195, 0.7, 0.8, 11000, new String[] {"Yellow", "Red"}, 10, -4.3, new String[] {"model by BIda"}),
	SDL39("SDL39", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselSDL39.class, ItemIDs.minecartSDL39.item, "diesel", 2300, 152, 0, 60, 0, 180, 0.8, 0.9, 6500, new String[] {"Orange", "Blue", "Red"}, 10, -3, new String[] {"model by binky"}),
	F7A("F7A", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselF7A.class, ItemIDs.minecartF7A.item, "diesel", 1500, 133, 0, 50, 0, 180, 0.7, 0.79, 4500, new String[] {"White", "Black", "Orange", "Yellow", "Grey", "Red"}, 10, -3, new String[] {"Model by Binky and Bida"}),
	F7B("F7B", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselF7B.class, ItemIDs.minecartF7B.item, "diesel", 1500, 133, 0, 50, 0, 180, 0.7, 0.79, 4500, new String[] {"White", "Black", "Orange", "Grey", "Red", "Yellow"}, 10, -3, new String[] {"Model by Binky and Bida. Its a B unit, but it can move on its own!"}),
	geGenesis("Ge Genesis", com.jcirmodelsquad.tcjcir.vehicles.locomotives.GeGenesis.class, ItemIDs.minecartGeGenesis.item, "diesel", 4250, 177, 0, 55, 0, 175, 0.93, 0.94, 10000, new String[] {"Grey", "LightGrey", "White"}, 10, -5.5, new String[] {"Model by MessicOOmer"}),
	ES44("ES44", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselES44.class, ItemIDs.minecartES44.item, "diesel", 4400, 120, 0, 60, 0, 190, 0.7, 0.8, 19000, new String[] {"Lime", "Orange", "Red", "Yellow", "Blue", "LightGrey", "Grey", "Black"}, 10, -4.3, new String[] {"Model by Eddie Dalton, upgraded by Bida"}),
	...
	GP13("GP13", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselGP13.class, ItemIDs.minecartGP13.item, "diesel", 2510,90,0,50,0,200,0.74,0.96,3000, new String[]{"Blue", "LightBlue", "Black", "Orange", "White", "Yellow"}, 10, 1.4, new String[] {"Fictional Rebuild of a GP7, Uses the original GP40 model"}),
	GP30("GP30", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselGP30.class, ItemIDs.minecartGP30.item, "diesel", 2250, 114, 0, 50, 0, 180, 0.7, 0.91, 6500, new String[] {"LightGrey", "Black", "Yellow", "Blue", "Orange", "White", "Grey", "Red", "Purple"}, 10, -3.1),
	...
	SD70Mac("SD70Mac", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselSD70Mac.class, ItemIDs.minecartSD70Mac.item, "diesel", 4000, 112, 0, 15, 0, 150, 0.6, 0.8, 19000, new String[]{"Red", "Blue", "Grey", "LightGrey", "LightBlue", "Yellow", "Black","Green", "Orange", "Lime", "Pink", "Magenta", "Brown"}, 18, -4, new String[] {"Original Model by Eddie, upgraded by Bida"}),
	...
	C424("C424", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselC424.class, ItemIDs.minecartC424.item, "diesel", 2400, 113, 0, 60, 0, 190, 0.7, 0.8, 6000, new String[]{"Yellow", "Orange", "Cyan", "Red"}, 10, -3.6),
	...
	F40PH("F40PH", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselF40PH.class, ItemIDs.minecartF40PH.item, "diesel", 3000, 103, 0, 50, 0, 170, 0.75, 0.95, 5500, new String[] {"LightGrey", "Grey", "Red", "Yellow", "Cyan"}, 10, -3.5, new String[] {"Model by Bida & Mr Coomer"}),
	GP7u("GP7u", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselGP7u.class, ItemIDs.minecartGP7u.item, "diesel", 1500, 100, 0, 55, 0, 170, 0.81, 0.93, 3000, new String[] {"Red", "Blue", "LightGrey", "Grey", "White", "Yellow"}, 10, -3),
	GP7("GP7", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselGP7.class, ItemIDs.minecartGP7.item, "diesel", 1500, 105, 0, 55, 0, 170, 0.81, 0.93, 3000, new String[] {"Yellow", "Blue", "White", "Brown", "Black", "Red", "Green", "Purple", "LightGrey"}, 10, -3, new String[] {"Built by Bida"}),
	SDP40F("SDP40F",com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselSDP40F.class, ItemIDs.minecartSDP40F.item, "diesel", 3000, 160, 0, 65, 0, 190, 0.8, 0.9, 12000, new String[] {"LightBlue", "White", "LightGrey", "Grey", "Yellow"}, 10, -3.95, new String[] {"Model by Prof_Binky"}),
	gtavthing("gtavthing", com.jcirmodelsquad.tcjcir.vehicles.locomotives.Dieselgtavthing.class, ItemIDs.minecartgtavthing.item, "diesel", 1550, 110, 0, 45, 0, 160, 0.85, 0.9, 6500, new String[] {"Yellow"}, 10, -3.2, new String[] {"Fictional locomotive from GTAV"}),
	HH660("HH660", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselHH660.class, ItemIDs.minecartHH660.item, "diesel", 660, 50, 0, 40, 0, 165, 0.9, 0.95, 2500, new String[] {"Black", "Yellow"}, 10, -2),
	...
	MP15DCW9("MP15DCW9", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselMP15DCW9.class, ItemIDs.minecartMP15DCW9.item, "diesel", 1500, 97, 0, 50, 0, 100, 0.8, 0.9, 4000, new String[] {"Orange", "White"}, 10, -2.3),
	...
	GP9("GP9", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselGP9.class, ItemIDs.minecartGP9.item, "diesel", 1750, 100, 0, 55, 0, 170, 0.81, 0.93, 3000, new String[] {"Grey", "Red", "Orange", "Magenta", "Yellow","Black","Brown","Blue","Green"}, 10, -3),
	C425("C425", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselC425.class, ItemIDs.minecartC425.item, "diesel", 2500, 113, 0, 60, 0, 190, 0.7, 0.8, 6000, new String[]{"Black", "Orange"}, 10, -3.6),
	VO1000("VO1000", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselVO1000.class, ItemIDs.minecartVO1000.item, "diesel", 1000, 67, 0, 55, 0, 180, 0.8, 0.9, 2500, new String[]{"Green", "Pink", "Blue"}, 10, -2.2, new String[] {"Made by Prof_Binky"}),
	FP45("FP45",com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselFP45.class, ItemIDs.minecartFP45.item, "diesel", 3600, 145, 0, 65, 0, 190, 0.75, 0.9, 12000, new String[] {"Orange", "Yellow", "LightGrey", "Grey"}, 10, -3.95, new String[] {"Model by Prof_Binky"}),
	F45("F45",com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselF45.class, ItemIDs.minecartF45.item, "diesel", 3600, 145, 0, 65, 0, 190, 0.75, 0.9, 12000, new String[] {"LightBlue", "Green", "Blue", "Yellow", "Red"}, 10, -3.65, new String[] {"Model by Prof_Binky"}),
	GP7b("GP7b", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselGP7b.class, ItemIDs.minecartGP7b.item, "diesel", 1500, 105, 0, 55, 0, 170, 0.81, 0.93, 3000, new String[] {"Blue", "White"}, 10, -3, new String[] {""}),
	SD40T2("SD40T-2", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselSD40T2.class, ItemIDs.minecartSD40T2.item, "diesel", 3000, 105, 0, 60, 0, 190, 0.75, 0.89, 12000, new String[] {"LightGrey", "Grey", "Blue", "White", "Black", "Red"}, 10, -3.8),
	...
	CF7R("CF7R", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselCF7R.class, ItemIDs.minecartCF7R.item, "diesel", 2350, 105, 0, 45, 0, 185, 0.8, 0.9, 4500, new String[] {"Blue", "Yellow", "Black"}, 10, -3, new String[] {"CF7 Rebuild Rebuilt"}),
	...
	SD45dash2B("SD45-2B", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselSD45dash2B.class, ItemIDs.minecartSD45dash2B.item, "diesel", 3600, 132, 0, 65, 0, 190, 0.75, 0.89, 12000, new String[] {"Blue", "Yellow", "Red", "White"}, 10, -3.8),
	GP38dash2("GP38dash2", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselGP38dash2.class, ItemIDs.minecartGP38dash2.item, "diesel", 2000, 105, 0, 60, 0, 180, 0.75, 0.9, 6500, new  String[] {"Cyan", "Green", "LightGrey", "Red", "Blue", "Yellow", "Orange", "Grey", "Black"}, 10, -3.1),
	...
	B23("B23-7", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselB23.class, ItemIDs.minecartB23.item, "diesel", 2250, 90, 0, 65, 0, 190, 0.74, 0.91, 8000, new String[] {"Yellow", "Red", "Blue", "LightGrey"}, 10, -3.3),
	...
	C415H("C415H", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselC415H.class, ItemIDs.minecartC415H.item, "diesel", 1500, 106, 0, 45, 0, 170, 0.87, 0.93, 4000, new String[] {"Purple", "LightGrey"}, 10, -2.5),
	...
	Beep("Beep", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselBeep.class, ItemIDs.minecartBeep.item, "diesel", 1500, 105, 0, 65, 0, 180, 0.89, 0.91, 2500, null, 10, -2.2),
	...
	NRE3gs21b("NRE3gs21b", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselNRE3gs21b.class, ItemIDs.minecartNRE3gs21b.item, "diesel genset", 2100, 104, 0, 30,0,  160, 0.78, 0.9, 11000, new String[]{"Yellow", "LightGrey", "Orange", "Grey"}, 10, -3.1),
	GP38dash9W("GP38dash9W", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselGP38dash9W.class, ItemIDs.minecartGP38dash9W.item, "diesel", 2000, 105, 0, 70, 0, 185, 0.75, 0.9, 6500, new  String[] {"Green", "Blue"}, 10, -3.1),
	Dash9_44CW("Dash9_44CW", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselDash9_44CW.class, ItemIDs.minecartDash9_44CW.item, "diesel", 4400, 119, 0, 65, 0, 190, 0.7, 0.83, 19000, new String[] {"LightGrey", "Grey", "Green","Black"}, 10, -4.3),
	GP15("GP15", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselGP15.class, ItemIDs.minecartGP15.item, "diesel", 1800, 105, 0, 50, 0, 160, 0.79, 0.93, 9000, new  String[] {"Yellow", "White", "LightGrey"}, 10, -2.6),
	DOT11111000( "DOT11000", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.DOT11111000.class, ItemIDs.minecart11000DOT111.item, "tank", 0, 0, 4, 0, 0, 0, 0, 0, 41000, new String[] {"Black"}, 10, 0, new String[]{"Capacity: 41000mb"}),
	DOT11120600( "DOT20600", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.DOT11120600.class, ItemIDs.minecart20600DOT111.item, "tank", 0, 0, 5, 0, 0, 0, 0, 0, 78000, new String[] {"Grey"}, 10, 0, new String[]{"Capacity: 78000mb"}),
	...
	F3A("F3A", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselF3A.class, ItemIDs.minecartF3A.item, "diesel", 1500, 133, 0, 50, 0, 180, 0.7, 0.79, 4500, new String[] {"Blue"}, 10, -3, new String[] {"So we heard you like the FTs how about this?"}),
	U36C("U36C", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselU36C.class, ItemIDs.minecartU36C.item, "diesel", 3600, 113, 0, 65, 0, 180, 0.75, 0.84, 11000, new String[] {"Grey", "Blue", "Red", "Yellow", "Orange"}, 10, -4, new String[] {"Since EMD has a large power engine why not us? -GE"}),
	E9A("E9A", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselE9A.class, ItemIDs.minecartE9A.item, "diesel", 2400, 188, 0, 65, 0, 180, 0.8, 0.89, 4500, new String[] {"LightGrey", "Grey"}, 10, -3, new String[] {"Well since we sold so many of the last one no one really wants this one."}),
	E8A("E8A", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselE8A.class, ItemIDs.minecartE8A.item, "diesel", 2250, 188, 0, 65, 0, 180, 0.8, 0.89, 4500, new String[] {"Grey", "White"}, 10, -3, new String[] {"Want a decent passenger engine?"}),
	;
