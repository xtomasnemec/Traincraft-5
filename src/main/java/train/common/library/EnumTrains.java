...
public enum EnumTrains {
	...
	GP7("GP7", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselGP7.class, ItemIDs.minecartGP7.item, "diesel", 1500, 105, 0, 55, 0, 170, 0.81, 0.93, 10000, new String[] {"Yellow", "Blue", "White", "Brown", "Black", "Red", "Green", "Purple"}, 10, -3, new String[] {"Built by Bida"}),
