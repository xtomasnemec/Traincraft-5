...
public enum EnumTrains {
	...
	GP7("GP7", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselGP7.class, ItemIDs.minecartGP7.item, "diesel", 1750, 100, 0, 55, 0, 170, 0.81, 0.93, 10000, new String[] {"Yellow", "Blue", "White", "Brown", "Black", "Red"}, 10, -3, new String[] {"Built by Bida"}),
	...
	FP45("FP45",com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselFP45.class, ItemIDs.minecartFP45.item, "diesel", 3600, 137, 0, 55, 0, 170, 0.75, 0.85, 20000, new String[] {"Orange", "Yellow"}, 10, -5, new String[] {"Model by Prof_Binky"}),
	;
