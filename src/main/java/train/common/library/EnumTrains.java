...
public enum EnumTrains {
	...
	SD45dash2("SD45-2", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselSD45dash2.class, ItemIDs.minecartSD45dash2.item, "diesel", 3600, 132, 0, 65, 0, 190, 0.75, 0.89, 20000, new String[] {"Green", "White", "Black", "Orange", "Blue", "Pink", "Magenta", "LightBlue", "Yellow", "Grey","Red"}, 10, -3.8, new String[] {"Model by Bida"}),
