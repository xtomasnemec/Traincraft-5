...
public enum EnumTrains {
	...
	/** JCIR-TC*/
	locoAlcoS2("Alco S2",  com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselAlcoS2.class, ItemIDs.minecartAlcoS2.item, "diesel", 1000, 96, 0, 45, 0, 170, 0.7, 0.965, 9000, new String[] {"Black", "Grey", "Green", "Orange", "Pink", "White", "Blue", "LightGrey", "Magenta", "Red"}, 18, -2),
	...
	SW1("SW1", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselSW1.class, ItemIDs.minecartSW1.item, "diesel", 600, 105, 0, 45, 0, 160, 0.6, 0.890, 10000, new String[] {"Orange", "Green", "Blue", "Black", "Pink", "Cyan", "LightGrey", "White"}, 10, -1.8),
	H1044("H1044", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselH1044.class, ItemIDs.minecartH1044.item, "diesel", 1000, 97, 0, 45, 0, 175, 0.75, 0.92, 16000, new String[]{"Green", "Yellow", "Black", "Red", "Blue", "Grey", "LightBlue", "Orange", "White", "Lime"}, 18, -2.2),
	...
	U23B("U23B", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselU23B.class, ItemIDs.minecartU23B.item, "diesel", 2250, 70, 0, 55, 0, 180, 0.7, 0.91, 18000, new String[] {"Grey", "Orange", "LightGrey", "Pink", "Lime", "Blue", "LightBlue", "Black", "Green","Purple", "Brown", "Yellow"}, 10, -3.3),
	SW1500("SW1500", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselSW1500.class, ItemIDs.minecartSW1500.item, "diesel", 1500, 105, 0, 50, 0, 180, 0.85, 0.97, 18000, new String[] {"LightBlue", "Blue", "Orange", "Pink", "White", "LightGrey"}, 10, -2.3),
	SD45dash2("SD45-2", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselSD45dash2.class, ItemIDs.minecartSD45dash2.item, "diesel", 3600, 132, 0, 65, 0, 190, 0.75, 0.89, 20000, new String[] {"Green", "White", "Black", "Orange", "Blue", "Pink", "Magenta", "LightBlue", "Yellow", "Grey","Red", "LightGrey", "Purple", "Brown", "Lime", "skin16"}, 10, -3.8),
	SD40dash2("SD40-2", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselSD40dash2.class, ItemIDs.minecartSD40dash2.item, "diesel", 3000, 105, 0, 60, 0, 190, 0.75, 0.89, 20000, new String[] {"LightGrey", "Orange", "Green", "Pink", "Magenta", "White", "Yellow", "Black", "Blue", "Red", "Lime", "Brown", "Purple"}, 10, -3.8),
	...
	CF7("CF7", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselCF7.class, ItemIDs.minecartCF7.item, "diesel", 1500, 116, 0, 45, 0, 185, 0.8, 0.9, 20000, new String[] {"Yellow", "Red", "LightGrey", "White", "Cyan", "Lime", "Magenta", "Purple", "Green", "Blue", "Orange", "Pink", "Black", "Brown"}, 10, -3, new String[] {"Model version: 4.7"}),
	CF7round("CF7round", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselCF7round.class, ItemIDs.minecartCF7round.item, "diesel", 1500, 116, 0, 45, 0, 185, 0.8, 0.9, 20000, new String[] {"Blue", "Yellow", "White", "Orange", "Pink"}, 10, -3, new String[] {"Rotunde Boye"}),
	SD9("SD9", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselSD9.class, ItemIDs.minecartSD9.item, "diesel", 1750, 104, 0, 50, 0, 190, 0.75, 0.89, 19000, new String[] {"Black", "Green", "Cyan", "Orange", "White"}, 10, -3.1),
	...
	SF30C("SF30C", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselSF30C.class, ItemIDs.minecartSF30C.item, "diesel", 3000, 121, 0, 55, 0, 195, 0.7, 0.8, 21000, new String[] {"Yellow", "Red"}, 10, -4.3, new String[] {"model by BIda"}),
	...
	Boxcab23Ton("23 Ton Boxcab", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselBoxcab23Ton.class, ItemIDs.minecartBoxcab23Ton.item, "diesel", 150, 40, 0, 20, 0, 100, 0.7, 0.8, 5000,  new String[] {"Blue", "White", "Black", "Green"}, 10, -1.5),
	...
	GP30("GP30", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselGP30.class, ItemIDs.minecartGP30.item, "diesel", 2250, 114, 0, 50, 0, 180, 0.7, 0.91, 18000, new String[] {"LightGrey", "Black", "Yellow", "Blue", "Orange", "White", "Grey", "Red", "Purple"}, 10, -3.1),
	...
	SD70Mac("SD70Mac", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselSD70Mac.class, ItemIDs.minecartSD70Mac.item, "diesel", 4000, 112, 0, 15, 0, 150, 0.6, 0.8, 17000, new String[]{"Red", "Blue", "Grey", "LightGrey", "LightBlue", "Yellow", "Black","Green", "Orange", "Lime", "Pink", "Magenta", "Brown"}, 18, -4, new String[] {"Original Model by Eddie, upgraded by Bida"}),
	...
	C424("C424", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselC424.class, ItemIDs.minecartC424.item, "diesel", 2400, 113, 0, 60, 0, 190, 0.7, 0.8, 19000, new String[]{"Yellow", "Orange", "Cyan", "Red"}, 10, -3.6),
	...
	GP7u("GP7u", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselGP7u.class, ItemIDs.minecartGP7u.item, "diesel", 1500, 100, 0, 55, 0, 170, 0.81, 0.93, 10000, new String[] {"Red", "Blue", "LightGrey", "Grey", "White", "Yellow"}, 10, -3),
	GP7("GP7", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselGP7.class, ItemIDs.minecartGP7.item, "diesel", 1500, 105, 0, 55, 0, 170, 0.81, 0.93, 10000, new String[] {"Yellow", "Blue", "White", "Brown", "Black", "Red", "Green", "Purple", "LightGrey"}, 10, -3, new String[] {"Built by Bida"}),
	...
	GP9("GP9", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselGP9.class, ItemIDs.minecartGP9.item, "diesel", 1750, 100, 0, 55, 0, 170, 0.81, 0.93, 10000, new String[] {"Grey", "Red", "Orange", "Magenta", "Yellow","Black","Brown","Blue","Green"}, 10, -3),
	C425("C425", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselC425.class, ItemIDs.minecartC425.item, "diesel", 2500, 113, 0, 60, 0, 190, 0.7, 0.8, 19000, new String[]{"Black", "Orange"}, 10, -3.6),
	...
	SD40T2("SD40T-2", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselSD40T2.class, ItemIDs.minecartSD40T2.item, "diesel", 3000, 105, 0, 60, 0, 190, 0.75, 0.89, 20000, new String[] {"LightGrey", "Grey", "Blue", "White", "Black", "Red"}, 10, -3.8),
	...
	GP38dash2("GP38dash2", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselGP38dash2.class, ItemIDs.minecartGP38dash2.item, "diesel", 2000, 105, 0, 60, 0, 180, 0.75, 0.9, 20000, new  String[] {"Cyan", "Green", "LightGrey", "Red", "Blue", "Yellow", "Orange", "Grey", "Black"}, 10, -3.1),
	...
	B23("B23-7", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselB23.class, ItemIDs.minecartB23.item, "diesel", 2250, 90, 0, 65, 0, 190, 0.74, 0.91, 20000, new String[] {"Yellow", "Red", "Blue", "LightGrey"}, 10, -3.3),
	...
	Dash9_44CW("Dash9_44CW", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselDash9_44CW.class, ItemIDs.minecartDash9_44CW.item, "diesel", 4400, 119, 0, 65, 0, 190, 0.7, 0.83, 25000, new String[] {"LightGrey", "Grey", "Green"}, 10, -4.3),//MAKE SURE TO ADD A CAB IN THE MODEL FILE
	GP15("GP15", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselGP15.class, ItemIDs.minecartGP15.item, "diesel", 1800, 105, 0, 50, 0, 160, 0.79, 0.93, 10000, new  String[] {"Yellow", "Cyan", "LightGrey"}, 10, -2.6),
	...
	DOT11120600( "DOT11000", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.DOT11120600.class, ItemIDs.minecart20600DOT111.item, "tank", 0, 0, 5, 0, 0, 0, 0, 0, 78000, new String[] {"Grey"}, 0, 27, new String[]{"Capacity: 78000mb"}),
	DOT11129080( "DOT11000", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.DOT11129080.class, ItemIDs.minecart29080DOT111.item, "tank", 0, 0, 6, 0, 0, 0, 0, 0, 110000, new String[] {"Black", "Orange", "LightGrey", "White"}, 10, 0, new String[]{"Capacity: 110000mb"}),
	tankWagonUS2("Tank Wagon US", EntityTankWagonUS.class, ItemIDs.minecartTankWagonUS.item, "tank", 0, 0, 6, 0, 0, 0, 0, 0, 70000, (new String[]{"Black", "Grey", "Yellow", "White", "LightGrey", "Green", "Blue", "Lime", "Orange", "Cyan", "Pink", "Purple", "LightBlue", "Magenta","Red","Brown"}), 18, 0, new String[]{"Capacity: 70000mb"}),
