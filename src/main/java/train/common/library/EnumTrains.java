	...
	public static TrainRecord[] trains() {
		return new TrainRecord[]{
				...
				*/
				...
				TrainRecord.makeEntry("DuewagGT6ERLoco", "DuewagGT6ERLoco", EntityElectricDuewagGT6ERLoco.class, ItemIDs.minecartDuewagGT6ERLoco.item, "electric", 250, 70, 0, 20, 0, 100, 0.7, 0.8, 1000, new String[]{"Magenta", "Green", "LightBlue", "White", "Grey", "Orange", "Red", "Yellow", "Purple"}, 18, -1.95, "Pack: Trams In Motion"),
				TrainRecord.makeEntry("DuewagGT6ERTail", "DuewagGT6ERTail", EntityPassengerDuewagGT6ERTail.class, ItemIDs.minecartDuewagGT6ERTail.item, "passenger", 0, 0, 1, 0, 0, 0, 0, 0, 0, new String[]{"Magenta", "Green", "LightBlue", "White", "Grey", "Orange", "Red", "Yellow", "Purple"}, 18, -1.35, "Pack: Trams In Motion"),
