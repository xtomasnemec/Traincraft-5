...
public enum EnumTrains {
	...
	tankWagonUS("Tank Wagon US", EntityTankWagonUS.class, ItemIDs.minecartTankWagonUS.item, "tank", 0, 0, 6, 0, 0, 0, 0, 0, 70000, (new String[]{"Black", "Grey", "Yellow", "White", "LightGrey", "Green", "Blue", "Lime", "Orange", "Cyan", "Pink", "Purple", "LightBlue", "Magenta"}), 18, 0, new String[]{"Capacity: 70000mb"}),
	...
	locoElectricSpeedZeroED("Loco Electric High Speed ZeroED", EntityLocoElectricHighSpeedZeroED.class, ItemIDs.minecartLocoHighSpeedZeroED.item, "electric", 700, 400, 0, 3, 0,230, 10, 0.98, 0, new String[]{"White", "LightGrey", "Grey"}, 13,  -3.4),
	...
	/** JCIR-TC*/
	locoAlcoS2("Alco S2",  com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselAlcoS2.class, ItemIDs.minecartAlcoS2.item, "diesel", 1000, 96, 0, 45, 0, 170, 0.7, 0.965, 8000, new String[] {"Black", "Grey", "Green", "Orange", "Pink", "White", "Blue", "LightGrey", "Magenta", "Mayeeta", "Red"}, 18, -2, new String[] { "Created by Bidahochi" }),
	...
	SW1("SW1", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselSW1.class, ItemIDs.minecartSW1.item, "diesel", 600, 105, 0, 45, 0, 160, 0.6, 0.890, 10000, new String[] {"Orange", "Green", "Blue", "Black", "Pink", "Cyan", "LightGrey", "White"}, 10, -2.1, new String[] {"model by Bida as usual kEk"}),
	...
	U23B("U23B", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselU23B.class, ItemIDs.minecartU23B.item, "diesel", 2250, 70, 0, 55, 0, 180, 0.7, 0.91, 18000, new String[] {"Grey", "Orange", "LightGrey", "Pink", "Lime", "Blue", "LightBlue", "Black", "Green","Purple", "Brown"}, 10, -3.7, new String[] {"Made by Bida"}),
	...
	SD45dash2("SD45-2", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselSD45dash2.class, ItemIDs.minecartSD45dash2.item, "diesel", 3600, 132, 0, 65, 0, 190, 0.75, 0.89, 20000, new String[] {"Green", "White", "Black", "Orange", "Blue", "Pink", "Magenta", "LightBlue", "Yellow", "Grey"}, 10, -3.8, new String[] {"Model by Bida"}),
	SD40dash2("SD40-2", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselSD40dash2.class, ItemIDs.minecartSD40dash2.item, "diesel", 3000, 105, 0, 60, 0, 190, 0.75, 0.89, 20000, new String[] {"LightGrey", "Orange", "Green", "Pink", "Magenta", "White", "Yellow", "Black", "Blue", "Red", "Lime", "Brown"}, 10, -3.8, new String[] {"Model by the great and powerful Bida"}),
	bawx40highcube("40highcube", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.bawx40highcube.class, ItemIDs.minecart40highcube.item, "freight", 4, new String[] {"Brown", "Green", "Cyan", "Orange", "Grey", "Red"}, 0, 40, new String[] {"Model by Prof Binky"}),
	...
	CF7("CF7", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselCF7.class, ItemIDs.minecartCF7.item, "diesel", 1500, 116, 0, 45, 0, 185, 0.8, 0.9, 20000, new String[] {"Yellow", "Red", "LightGrey", "White", "Cyan", "Lime", "Magenta", "Purple", "Green", "Blue", "Orange", "Pink", "Black"}, 10, -3, new String[] {"Model version: 4.5 By Bida"}),
	...
	GP30("GP30", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselGP30.class, ItemIDs.minecartGP30.item, "diesel", 2250, 114, 0, 50, 0, 180, 0.7, 0.91, 18000, new String[] {"LightGrey", "Black", "Yellow", "Blue", "Orange", "White", "Grey", "Red"}, 10, -3.1, new String[] {"Made by Bida"}),
	...
	GP7("GP7", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselGP7.class, ItemIDs.minecartGP7.item, "diesel", 1500, 105, 0, 55, 0, 170, 0.81, 0.93, 10000, new String[] {"Yellow", "Blue", "White", "Brown", "Black", "Red"}, 10, -3, new String[] {"Built by Bida"}),
	...
	Freight66centerbeam("66centerbeam", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.Freight66centerbeam.class, ItemIDs.minecart66centerbeam.item, "freight", 4, new String[] {"Orange", "Cyan"}, 0, 54, new String[]{"Made by Prof_Binky"}),
    ...
    EF1("EF1",com.jcirmodelsquad.tcjcir.vehicles.locomotives.ElectricEF1.class, ItemIDs.minecartEF1.item, "electric", 1500, 64, 0, 55, 0, 150, 0.75, 0.85, 12500, new String[] {"Orange", "Yellow", "Red", "Green", "Black", "Grey"}, 10, -3.4375, new String[] {"Model by Prof_Binky"}),
	EP1A("EP1A",com.jcirmodelsquad.tcjcir.vehicles.locomotives.ElectricEP1A.class, ItemIDs.minecartEP1A.item, "electric", 2500, 120, 0, 55, 0, 150, 0.85, 0.95, 12500, new String[] {"Orange", "Red"}, 10, -3.4375, new String[] {"Model by Prof_Binky"}),
	;
