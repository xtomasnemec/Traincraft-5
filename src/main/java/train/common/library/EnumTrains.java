...
public enum EnumTrains {
	...
	bawx40highcube("40highcube", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.bawx40highcube.class, ItemIDs.minecart40highcube.item, "freight", 4, new String[] {"Brown", "Green", "Cyan", "Orange", "Grey", "Red", "Lime"}, 0, 40, new String[] {"Model by Prof Binky"}),
	...
	Freight73centerbeam("73centerbeam", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.Freight73centerbeam.class, ItemIDs.minecart73centerbeam.item, "freight", 7, new String[] {"Pink", "Cyan", "Green"}, 0, 54, new String[]{"Made by Prof_Binky"}),
