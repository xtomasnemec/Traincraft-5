...
public enum EnumTrains {
	...
	F7A("F7A", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselF7A.class, ItemIDs.minecartF7A.item, "diesel", 1500, 133, 0, 50, 0, 180, 0.7, 0.79, 4500, new String[] {"White", "Black", "Orange", "Yellow", "Grey", "Red"}, 10, -2.5, new String[] {"Model by Binky and Bida"}),
	F7B("F7B", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselF7B.class, ItemIDs.minecartF7B.item, "diesel", 1500, 133, 0, 50, 0, 180, 0.7, 0.79, 4500, new String[] {"White", "Black", "Orange", "Grey", "Red", "Yellow"}, 10, -2.4375, new String[] {"Model by Binky and Bida. Its a B unit, but it can move on its own!"}),
	...
	F3A("F3A", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselF3A.class, ItemIDs.minecartF3A.item, "diesel", 1500, 133, 0, 50, 0, 180, 0.7, 0.79, 4500, new String[] {"Blue"}, 10, -2.5, new String[] {"So we heard you like the FTs how about this?"}),
