...
public enum RenderEnum {
	...
	BoulderWagon(com.jcirmodelsquad.tcjcir.vehicles.rollingstock.BoulderWagon.class, new ModelBoulderWagon(),"BoulderWagon",false, new float[]{0F,0F,0F}, new float[] { 0F, 180F, 180F },null, "",0,null,  "",null, 0,false),
