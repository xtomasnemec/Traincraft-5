...
public class GuiGeneratorDiesel extends GuiContainer {
    ...
    protected void drawCreativeTabHoveringText(String str, int t, int g) {
        int textWidth = fontRenderer.getStringWidth(dieselInventory.theTank.getFluidAmount() + "/" + dieselInventory.getTankCapacity());
        int startX = t + 14;
        int startY = g - 12;
        int i4 = 0xf0100010;
        ...
        fontRenderer.drawStringWithShadow(dieselInventory.theTank.getFluidAmount() + "/" + dieselInventory.getTankCapacity(), startX, startY + 10, -1);
    }
