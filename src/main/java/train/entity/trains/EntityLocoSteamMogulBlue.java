...
public class EntityLocoSteamMogulBlue extends EntityTrainCore {
    ...
    @Override
    public float[][] modelOffsets(){return new float[][]{{0.3f, getWorld()==null?0.4f:0.64f, 0.0f}};}
    @Override
    ...
    @Override
    public float[] getHitboxSize(){return new float[]{getWorld()==null?3.5f:3.2f,2.4f,1.1f};}
    @Override
